---
title: 'Firebase Auth로 OAuth 2.0 흐름 해부'
pubDate: 2025-08-11
date: 2025-08-11
description: 'Firebase Authentication을 사용한 OAuth 2.0 프로토콜을 단계별로 살펴봅니다.'
...
import popup from './asset/popup.mp4';
...
<video autoplay loop muted playsinline s>
